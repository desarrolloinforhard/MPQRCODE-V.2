...
class GUIconexiones:
    ...
    def frame_botton(self):
        ...
        customtkinter.CTkButton(self.frame_ventana_principal, text="Configurar Sucursal", command=self.eliminar_sucursal_app).grid(row=0, column=1, pady=5, padx=5, sticky='nsew')
